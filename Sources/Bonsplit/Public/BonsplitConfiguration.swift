...
public enum ContentViewLifecycle: Sendable {
  ...
  /// view state like scroll position, editor state, and focus.
  case recreateOnSwitch

  /// All tab content views are kept in the view hierarchy, with non-selected tabs
  /// hidden. This preserves all view state (scroll position, editor state, focus, etc.)
...
extension BonsplitConfiguration {
  public struct SplitActionButton: Sendable, Codable, Hashable, Identifiable {
    public enum Icon: Sendable, Codable, Hashable {
      ...
      private static func emojiScale(in container: KeyedDecodingContainer<CodingKeys>) throws
        -> Double
      {
    ...
    public init(from decoder: Decoder) throws {
      ...
      activatesOnMouseDown =
        try container.decodeIfPresent(Bool.self, forKey: .activatesOnMouseDown) ?? false
    }
  ...
  public struct SplitButtonTooltips: Sendable, Equatable {
    ...
    public init(
      newTerminal: String? = nil,
      newBrowser: String? = nil,
      splitRight: String? = nil,
      splitDown: String? = nil
    ) {
      self.newTerminal =
        newTerminal
        ?? Bundle.module.localizedString(
          forKey: "splitButton.newTerminal",
          value: "New Terminal",
          table: nil
        )
      self.newBrowser =
  ...
  public struct Appearance: Sendable {
    ...
    public struct SplitButtonBackdropEffect: Sendable {
      ...
      public init(
        ...
        self.solidSurfaceWidthAdjustment =
          solidSurfaceWidthAdjustment.isFinite
