...
struct TabItem: Identifiable, Hashable, Codable {
  ...
  init(from decoder: Decoder) throws {
    ...
    self.showsNotificationBadge =
      try c.decodeIfPresent(Bool.self, forKey: .showsNotificationBadge) ?? false
    ...
    self.showsRemoteIndicator =
      try c.decodeIfPresent(Bool.self, forKey: .showsRemoteIndicator) ?? false
  }
